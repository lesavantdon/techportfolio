...
const Projects = () => {
  return (
    <div>
      <h1 style={{ textDecoration: "underline", textAlign: "center", marginBottom: "40px" }}>Project Page</h1>
      <div>
      <h2>1. Personalized Fitness App Tracker  </h2>
      ...
      <div>
      <h2>2. Greenhouse Plant Tracker </h2>
